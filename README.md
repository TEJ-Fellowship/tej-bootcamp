...
- [Add state for visibility filter by putting it in another reducer using Combined reducers](https://youtu.be/rcpL-njJ1os)
...
- [Using Redux Toolkit](https://youtu.be/O0KUR51dVJg)
...
- [Using thunk to move server connection logic to Redux action creator](https://youtu.be/TWX0UMuQFaI)
  ...
  - move all Redux store creation code from `main.jsx` to `store.js`
  - in `main.jsx` import the store to pass to `App`
...
- [Setup the relational database](https://youtu.be/RAHJL-b9tpA)
...
- [Create notes-server to connect to relational database](https://youtu.be/oSNn53Q1Whw)
...
- [Using Sequelize ORM](https://youtu.be/ePhf1wFKeU8)
...
- [Additional notes on relational database](https://youtu.be/kTL1Z9zYzRE)
...
- [Refactoring the code](https://youtu.be/ras9v-u2eRw)
...
- [Create user login](https://youtu.be/bM0eh7lvDXs)
  1. Create `User` model
...
- [Add user to note](https://youtu.be/TzmNJajLGhU)
...
- [Cleaning up & more queries](https://youtu.be/jQyJ2OwF6yE)
...
- [Data migration the proper way](https://youtu.be/rgKFnUlLSto)
...
- [Admin user and user disabling](https://youtu.be/RBNCoVZDamA)
  1. Create a user
...
- [Creating many-to-many relationship to allow users to be part of multiple teams](https://youtu.be/1Bnu0TMIxBs)
...
- [Revisiting many-to-many relationships](https://youtu.be/FMbQo8cuNYI)
...
- [Concluding remarks](https://youtu.be/j5dmdVQApKc)
